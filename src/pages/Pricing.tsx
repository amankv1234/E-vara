...
const PricingPage = () => {
  useSEO({
    ...
    description: "High-ticket concierge OSINT and Deepfake monitoring for PR firms, family offices, and executives.",
    ...
    <div className="min-h-screen bg-[#050608] text-white selection:bg-primary/30 font-mono">
      <nav className="h-20 border-b border-white/5 bg-[#050608]/50 backdrop-blur-xl sticky top-0 z-50">
        <div className="container mx-auto h-full px-6 flex items-center justify-between">
          ...
          <Link to="/auth">
            <Button variant="ghost" className="text-[10px] uppercase font-bold tracking-widest hover:bg-white/5">Client Portal</Button>
          </Link>
        </div>
      </nav>
      ...
      <div className="container mx-auto px-6 py-24">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="relative rounded-[32px] border border-white/5 bg-[#0A0C12] p-10 flex flex-col transition-all hover:translate-y-[-8px]">
            <div className="mb-8">
              <h3 className="text-sm font-bold uppercase tracking-[0.3em] text-muted-foreground mb-4">One-Time Assessment</h3>
              <div className="flex items-baseline gap-2">
                <span className="text-5xl font-black tracking-tighter text-white">$999</span>
              </div>
              <p className="mt-4 text-sm text-muted-foreground font-body">
                A highly detailed, manual OSINT deep-dive into your executive's digital footprint. Identifies all currently exposed vulnerabilities and deepfakes.
              </p>
            </div>
          ...
          <div className="relative rounded-[32px] border border-[#007AFF] bg-[#007AFF]/[0.03] shadow-[0_0_50px_rgba(0,122,255,0.1)] p-10 flex flex-col transition-all hover:translate-y-[-8px]">
            ...
            <div className="mb-8">
              <h3 className="text-sm font-bold uppercase tracking-[0.3em] text-[#007AFF] mb-4">Crisis PR Radar</h3>
              <div className="flex items-baseline gap-2">
                <span className="text-5xl font-black tracking-tighter text-white">$2,500</span>
                <span className="text-muted-foreground font-bold">/month</span>
              </div>
              <p className="mt-4 text-sm text-muted-foreground font-body">
                Continuous 24/7 monitoring of up to 5 executives. We alert your PR team the moment a synthetic media threat or data leak hits dark channels.
              </p>
            </div>
            ...
            <div className="space-y-4 mb-10 flex-grow">
              {[
                ...
                <div key={j} className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-mono text-white tracking-tight">{feature}</span>
                </div>
              ))}
            </div>
        ...
        <div className="mt-24 max-w-5xl mx-auto grid md:grid-cols-2 gap-12 p-12 rounded-[40px] border border-[#007AFF]/20 bg-[#007AFF]/[0.02]">
          <div>
            <h4 className="text-2xl font-black uppercase mb-4 text-white">The Intelligence Guarantee</h4>
            <p className="text-white/60 font-body leading-relaxed mb-6">
              Our pledge to Crisis PR Directors and Talent Managers: <strong>If we run an executive audit and find absolutely zero exposed vulnerabilities or synthetic footprints, you pay nothing.</strong> We are in the business of absolute truth, not software subscriptions.
            </p>
          ...
          <div className="space-y-6">
             <div className="p-6 rounded-2xl border border-white/5 bg-white/[0.02]">
               <div className="flex items-center gap-3 mb-2">
                 ...
                 <span className="text-[10px] font-bold uppercase tracking-widest text-white">Actionable Reporting</span>
               </div>
               <p className="text-xs text-white/50 font-body">We provide raw intelligence, heavily filtered by our analysts, giving your legal team exactly what they need for immediate takedowns.</p>
             </div>
             <div className="p-6 rounded-2xl border border-white/5 bg-white/[0.02]">
               <div className="flex items-center gap-3 mb-2">
                 <Globe className="h-4 w-4 text-[#007AFF]" />
                 <span className="text-[10px] font-bold uppercase tracking-widest text-white">Dark Network Reach</span>
               </div>
               <p className="text-xs text-white/50 font-body">We crawl private Telegram groups, 4chan, and decentralized networks where deepfakes are born.</p>
             </div>
          </div>
        </div>
      </div>
