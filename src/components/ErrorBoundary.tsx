...
import { AlertOctagon, RefreshCw, Terminal, Home, AlertCircle } from "lucide-react";
    ...
    if (this.state.hasError) {
      return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#05060a] text-[#ff453a] font-mono p-4 overflow-y-auto">
          <div className="absolute inset-0 opacity-10 pointer-events-none" style={{ backgroundImage: "linear-gradient(rgba(255,69,58,0.15) 1px, transparent 1px), linear-gradient(90deg, rgba(255,69,58,0.15) 1px, transparent 1px)", backgroundSize: "30px 30px" }} />
          ...
          <div className="max-w-xl w-full border border-[#ff453a]/30 bg-[#0c0f16]/95 rounded-2xl p-6 sm:p-8 relative overflow-hidden shadow-[0_0_50px_rgba(255,69,58,0.15)]">
            ...
            <div className="mb-6 flex items-center gap-4">
              ...
              <div>
                <h1 className="text-sm font-black tracking-[0.25em] uppercase text-white">Cyber Command Alert</h1>
                <p className="text-[9px] text-[#ff453a]/70 uppercase tracking-widest font-bold">Resiliency layer engaged</p>
              </div>
            </div>
            ...
            <p className="text-xs text-muted-foreground font-body leading-relaxed mb-6">
              A critical failure occurred inside the system pipeline. E-VARA's universal self-healing layer has intercepted the crash to prevent browser blackout.
            </p>
