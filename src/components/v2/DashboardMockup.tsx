        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/5 bg-white/[0.02]">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-mono font-bold uppercase tracking-widest text-white/70">Secure_Node: Delta-09</span>
            </div>
          </div>
        ...
        <div className="p-4 sm:p-6 md:p-8 grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="p-6 rounded-2xl border border-white/5 bg-white/[0.03] space-y-4">
              ...
              <p className="text-[10px] text-success font-mono">STATUS: MINIMAL_EXPOSURE</p>
            </div>
            ...
            <div className="p-6 rounded-2xl border border-white/5 bg-white/[0.03] space-y-4">
              ...
              <div className="grid grid-cols-8 gap-1">
                {Array.from({ length: 8 }).map((_, i) => (
                  <div key={i} className={`h-8 rounded-sm ${i < 7 ? 'bg-electric-blue/20' : 'bg-electric-blue/5'}`} />
                ))}
              </div>
            </div>
          </div>
            ...
            <div className="h-[280px] rounded-2xl border border-white/5 bg-white/[0.02] relative overflow-hidden flex items-center justify-center">
              ...
              {Array.from({ length: 5 }).map((_, i) => (
                ...
                >
                  ...
                  <span className="text-[8px] font-mono text-white/60">SCANNING_DATA_STREAM_{i}</span>
                </motion.div>
              ))}
            </div>
